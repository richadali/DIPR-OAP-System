        ...
        success: function (response) {
            ...
            $.each(response, function (indexInArray, valueOfElement) {
                table +=
                    ...
                    "</td>" +
                    '<td class="text-center">' +
                    valueOfElement.subject_name +
                    "</td>";
                table +=
                    '<td class="text-center"><span style="color:darkblue;" data-id="' +
                    valueOfElement.id +
                    '"class="icon ri-edit-2-fill subject-edit"></span> &nbsp; &nbsp;<span style="color:red;" data-id="' +
                    valueOfElement.id +
                    '" class="icon ri-chat-delete-fill subject-delete"></span> </td>';
                ("</tr>");
            });
