    ...
    $.ajax({
      ...
      success: function (response) {
          ...
          $.each(response, function (indexInArray, valueOfElement) { 
               ...
               table += '<td class="text-center"><span style="color:darkblue;" data-id="'+ valueOfElement.id+'"class="icon ri-edit-2-fill advertisement-edit"></span> &nbsp; &nbsp;<span style="color:red;" data-id="'+ valueOfElement.id+'" class="icon ri-chat-delete-fill advertisement-delete"></span> </td>'
               '</tr>';
          });
      ...
      $('#advertisement-form').on('submit', function(e) {
          ...
          $.ajax({
            ...
            success:function(data){
              console.log(data);
              if(data['flag']=='Y'){ //Succcess for creation of new advertisement type
                $(".table_msg1").show();
              ...
              else if(data['flag']=='YY'){ //Succcess for editing an advertisement type
                $(".table_msg5").show();
              ...
              else if(data['flag']=='N'){  //Error while creation of new advertisement type
                $(".table_msg2").show();
              ...
              else if(data['flag']=='NN'){ //Error while editing an advertisement type
                $(".table_msg6").show();
