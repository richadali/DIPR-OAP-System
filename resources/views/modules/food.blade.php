...
<main id="main" class="main">
            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100 active" id="food-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-food" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Food List</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="foods-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-foods" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="ri-file-add-line"></i>  &nbsp; Create/Edit Food</button>
                </li>
              </ul>
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                <div class="tab-pane fade show active" id="bordered-justified-food" role="tabpanel" aria-labelledby="food-tab">
                ...
                <div class="tab-pane fade" id="bordered-justified-foods" role="tabpanel" aria-labelledby="foods-tab">
                <form id="form-food" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="alert alert-success alert-block table_msg1" style="display:none;">
                    ...
                    <div class="col-md-6">
                      <label for="food_name" class="form-label"><b>Name</b></label>
                    ...
                    <div class="col-md-6">
                      <label for="food_img" class="form-label"><b>Upload image</b></label>
                    ...
                    <div calss="col-sm-6" style="display:none" id="has_image">
                      <img src="" id="food_imgs" class="card-img-bottom" alt="..."  width="100" height="200">
                    </div>
                    <br>
  ...
  <script src="{{asset('assets/js/modules/food.js')}}"></script>
@endsection