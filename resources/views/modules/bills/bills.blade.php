              ...
              <div class="modal fade" id="disablebackdrop" tabindex="-1" data-bs-backdrop="false">
                ...
                <form id="bill-form" method="POST" >
                  ...
                  <input type="hidden" id="id" name="id">
                        ...
                        <div class="col-md-6">
                          <label for="ad_id" class="form-label"><b>Reference No (MIPR No)</b></label>
                          <div>
                        ...
                        <div class="col-md-6">
                          <label for="dept_letter_no" class="form-label"><b>Dept Letter No</b></label>
                          <input type="text" class="form-control" id="dept_letter_no" name="dept_letter_no" readonly>
                      </div>
