...
<main id="main" class="main">
            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100 active" id="slider-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-home" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Conference</button>
                </li>
                <li class="nav-item flex-fill" role="presentation">
                  <button class="nav-link w-100" id="conferences-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-conference" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="ri-file-add-line"></i>  &nbsp; Create/Edit Conference</button>
                </li>
              </ul>
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <table class="conference_table" width="100%"> 
                <thead>
                  <tr>
                ...
                <div class="tab-pane fade" id="bordered-justified-conference" role="tabpanel" aria-labelledby="conferences-tab">
                  <form id="conference-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input type="hidden" id="id" name="id">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="conference_name" id="conference_name" required>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="file" class="form-control" id="conference_img" name="conference_img" required>
                        <span style="color:red"><i>*Support only jpeg,png,jpg,gif</i></span>
                      </div>
                      <br>
                      <div calss="col-sm-6" style="display:none" id="has_image">
                        <img src="" id="conferences_img" class="card-img-bottom" alt="..."  width="100" height="200">
                      </div>
                       <br>
  ...
  <script src="{{asset('assets/js/modules/conference.js')}}"></script>
@endsection