            ...
            <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
              <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab"
                  ...
                  aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Media Types List</button>
              </li>
              <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link w-100" id="users-tab" data-bs-toggle="tab"
                  ...
                  aria-selected="false"><i class="ri-file-add-line"></i> &nbsp; Add/Edit Media Type</button>
              </li>
            </ul>
            <div class="tab-content pt-2" id="borderedTabJustifiedContent">
              <div class="tab-pane fade show active" id="bordered-justified-food" role="tabpanel"
                ...
                <div class="alert alert-danger table_msg5" style="display:none;">
                  <strong>Oops!</strong> This data cannot be deleted because it is currently in use by another part of
                  the system.
                </div>
              ...
              <div class="tab-pane fade" id="bordered-justified-foods" role="tabpanel" aria-labelledby="users-tab">
                <form id="news_type_form" method="POST">
                  ...
                  <div class="col-md-6">
                    <label for="news_type" class="form-label"><b>Media Type</b></label>
