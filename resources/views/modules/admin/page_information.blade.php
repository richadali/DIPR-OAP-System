...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Page Information List</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Page Information</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
                            <li class="nav-item flex-fill" role="presentation">
                                <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab"
                                    data-bs-target="#bordered-justified-food" type="button" role="tab"
                            ...
                            <li class="nav-item flex-fill" role="presentation">
                                <button class="nav-link w-100" id="users-tab" data-bs-toggle="tab"
                                    data-bs-target="#bordered-justified-foods" type="button" role="tab"
                                    aria-controls="profile" aria-selected="false"><i class="ri-file-add-line"></i>
                                    &nbsp; Add/Edit Page Information</button>
                            </li>
                        </ul>
                                ...
                                <table class="user-table" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" scope="col" width="15%">Type</th>
                    ...
                    <th class="text-center" scope="col" width="15%">Phone No</th> -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" id="btn-send-user-notification"
                                ...
                                <div class="modal fade" id="userdocument_modal" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><span class="get-user-name"></span>'s
                                                    &nbsp;<span class='get-document-name'><span></h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                            ...
                            <div class="tab-pane fade" id="bordered-justified-foods" role="tabpanel"
                                ...
                                <form id="page-info-form" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <label for="page_info" class="form-label"><b>Page info name</b></label>
                                        <input type="text" class="form-control" id="page_info" name="page_info" required>
                                    </div>

                                    <!-- <div class="col-md-6">
                          <label for="head_off" class="form-label"><b>Head Office/Location</b></label>
                          <input type="text" class="form-control" id="head_off" name="head_off" maxlength="10" required>
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <input id="phone" type="phone" class="form-control" name="phone" autocomplete="new-phone">
                        </div> -->
                                    <br>
...
<script src="{{asset('assets/js/modules/admin/page_information.js')}}"></script>
@endsection