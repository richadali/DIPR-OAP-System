...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    <h1>Empanelled Organizations</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item">Empanelled Organizations</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
            ...
            <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
              <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab"
                  ...
                  aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Empanelled Organizations List</button>
              </li>
              <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link w-100" id="users-tab" data-bs-toggle="tab"
                  ...
                  aria-selected="false"><i class="ri-file-add-line"></i> &nbsp; Add/Edit Organization</button>
              </li>
            </ul>
            <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <table class="user-table" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th class="" scope="col" width="15%">Organization Name</th>
                      <th class="text-center" scope="col" width="15%">Media Type</th>
              ...
              <div class="tab-pane fade" id="bordered-justified-foods" role="tabpanel" aria-labelledby="users-tab">
                <form id="empanelled-form" method="POST">
                  ...
                  <div class="col-md-6">
                    <label for="news_type_id" class="form-label"><b>Media Type</b></label>
