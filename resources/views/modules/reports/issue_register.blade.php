            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-md-3" align=center>
                  ...
                  <div class="input-group">
                    <input id="from" type="text" class="form-control" name="from" required autocomplete="off"
                ...
                <div class="col-md-3" align=center>
                  ...
                  <div class="input-group">
                    <input id="to" type="text" class="form-control" name="to" required autocomplete="off"
                      placeholder="dd-mm-yyyy" readonly>
                    <span class="input-group-text"><i class="ri-calendar-line"></i></span>
                  </div>
                </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-2" align=center>
                  <input type="button" class="btn btn-primary btn-get-issue-register" value="Get Issue Register"
                    name="btn-get-issue-register" id="btn-get-issue-register">
                </div>
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="myTab" role="tablist">
              <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link w-100 active" id="user-tab" data-bs-toggle="tab"
                  ...
                  aria-selected="true"><i class="bi bi-card-list"></i> &nbsp;Issue Register</button>
              </li>
            </ul>
            <div class="tab-content pt-2" id="borderedTabJustifiedContent">
              <div class="tab-pane fade show active" id="bordered-justified-food" role="tabpanel"
                ...
                <table class="issueRegisterTable" width="100%">
                  <thead>
                    <tr>
